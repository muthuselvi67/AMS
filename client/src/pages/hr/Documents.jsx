...
import { Plus, FileText, Download, Trash2, Search, Eye, FileCheck } from 'lucide-react';
...
const Documents = () => {
    ...
    const handleTypeChange = (type) => {
        const selectedEmp = employees.find(e => e.id === form.employee);
    ...
    return (
        <div className="fade-in">
            ...
            <div className="filter-bar">
                ...
                <button className="btn btn-primary btn-sm" onClick={openCreate} style={{ flexShrink: 0 }}><Plus size={14} /> Generate Document</button>
            </div>
                                    ...
                                    <tr key={doc.id}>
                                        ...
                                        <td>
                                            <div style={{ display: 'flex', gap: 6 }}>
                                                ...
                                                <button className="btn btn-danger btn-sm btn-icon" onClick={() => handleDelete(doc.id)} title="Delete"><Trash2 size={14} /></button>
                                            </div>
                                        </td>
                                    </tr>
                                ))
