...
const Onboarding = () => {
    ...
    const openEdit = (item) => {
        setForm({
            employee: item.employee?.id || '', type: item.type,
    ...
    const handleSave = async (e) => {
        ...
        try {
            if (modal.mode === 'create') {
                ...
                await api.put(`/lifecycle/${modal.item.id}`, form);
                                        ...
                                        <tr key={ev.id}>
                                            ...
                                            <td>
                                                <div style={{ display: 'flex', gap: 6 }}>
                                                    ...
                                                    <button className="btn btn-danger btn-sm btn-icon" onClick={() => handleDelete(ev.id)} title="Delete"><Trash2 size={14} /></button>
                                                </div>
                                            </td>
                                        </tr>
                                    );
