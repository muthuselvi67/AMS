    ...
    const exportReport = async (type) => {
        ...
        try {
            const params = type === 'attendance'
                ? { ...attFilter, format: 'json' }
                : { ...leaveFilter, format: 'json' };
            ...
            <div className="card" style={{ marginTop: 20 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(240px,1fr))', gap: 12 }}>
                    {[
                        ...
                        { icon: '', title: 'Excel Format', desc: 'Reports are exported as Excel-compatible CSV files, fully readable in Microsoft Excel and Google Sheets' },
                    ].map(tip => (
