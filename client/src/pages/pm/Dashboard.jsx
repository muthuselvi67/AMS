...
const PMDashboard = () => {
    ...
    useEffect(() => {
        const load = async () => {
            try {
                ...
                setStats(projStats.data.data);
                setTaskStats(tStats.data.data);
                setProjects(projList.data.data?.projects?.slice(0, 5) || []);
                setTasks(taskList.data.data?.tasks?.slice(0, 5) || []);
    ...
    return (
        <div className="fade-in">
            ...
            {/* Full-width Calendar directly under header */}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                ...
                <div className="dashboard-grid" style={{ alignItems: 'start' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', minWidth: 0 }}>
                        ...
                        <div className="dashboard-top-row" style={{ marginBottom: 0 }}>
                            {/* Task status pie */}
                            <div className="card">
