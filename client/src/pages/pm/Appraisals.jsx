...
const PMAppraisals = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            setAppraisals(aRes.data.data?.appraisals || []);
                                    ...
                                    appraisals.map(a => {
                                        ...
                                        return (
                                            <tr key={a.id}>
                                                ...
                                                <td>
                                                    <button className="btn btn-primary btn-sm" onClick={() => navigate(`/pm/appraisals/${a.id}`)} disabled={!['submitted', 'under-review', 'hr-review', 'approved'].includes(a.status)}>
