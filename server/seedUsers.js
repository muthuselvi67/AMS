...
const dummyUsers = [
    // Admins (2)
    { name: 'Admin One', email: 'admin@lms.com', password: 'Admin@123', role: 'admin', employeeId: 'A101', department: 'Administration', position: 'System Admin' },
    ...
    // HR (3)
    { name: 'HR One', email: 'hr@lms.com', password: 'Hr@123', role: 'hr', employeeId: 'HR101', department: 'Human Resources', position: 'HR Manager' },
    ...
    // PM (3)
    { name: 'PM One', email: 'pm@lms.com', password: 'Pm@123', role: 'pm', employeeId: 'PM101', department: 'Project Management', position: 'Project Manager' },
...
for (let i = 1; i <= 12; i++) {
    ...
    dummyUsers.push({
        name: `Employee ${i}`,
        email: isFirst ? 'employee@lms.com' : `emp${i}@lms.com`,
        password: isFirst ? 'Employee@123' : 'Password@123',
        role: 'employee',
